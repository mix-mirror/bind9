...
/* ML-DSA-65 Constants */
#define DNS_KEY_MLDSA65SIZE  1952
#define DNS_SIG_MLDSA65SIZE  3309
#define MLDSA65_PRIVKEY_SIZE 4032

/* ML-DSA-87 Constants */
#define DNS_KEY_MLDSA87SIZE  2592
#define DNS_SIG_MLDSA87SIZE  4595
#define MLDSA87_PRIVKEY_SIZE 4896

/* Maximum sizes (ML-DSA-87) */
#define MAX_MLDSA_PUBKEY_SIZE  DNS_KEY_MLDSA87SIZE
#define MAX_MLDSA_PRIVKEY_SIZE MLDSA87_PRIVKEY_SIZE
#define MAX_MLDSA_SIG_SIZE     DNS_SIG_MLDSA87SIZE
