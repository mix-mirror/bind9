...
typedef enum {
	DNS_DELEGTYPE_UNDEFINED = 1 << 0,
	DNS_DELEGTYPE_DELEG_ADDRESSES = 1 << 1,
	DNS_DELEGTYPE_DELEG_NAMES = 1 << 2,
	DNS_DELEGTYPE_DELEG_PARAMS = 1 << 3,
	DNS_DELEGTYPE_NS_GLUES = 1 << 4,
	DNS_DELEGTYPE_NS_NAMES = 1 << 5
} dns_deleg_type_t;
