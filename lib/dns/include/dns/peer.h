...
isc_result_t
dns_peer_setdnsflags(dns_peer_t *peer, bool newval);

isc_result_t
dns_peer_getdnsflags(dns_peer_t *peer, bool *retval);

isc_result_t
dns_peer_setednsflags(dns_peer_t *peer, bool newval);

isc_result_t
dns_peer_getednsflags(dns_peer_t *peer, bool *retval);

isc_result_t
dns_peer_setednsneg(dns_peer_t *peer, bool newval);
