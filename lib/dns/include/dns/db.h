...
#define dns_db_find(db, name, version, type, options, now, foundname, rdataset, \
		    sigrdataset)                                               \
...
#define dns_db_findext(db, name, version, type, options, now, foundname,      \
	...
	dns__db_find(db, name, version, type, options, now, foundname, methods, \
		     clientinfo, rdataset, sigrdataset DNS__DB_FILELINE)
isc_result_t
