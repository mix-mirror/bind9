 ...
 * The change is immediately visible to dns_db_getsigningtime(), before
 * 'version' is committed, and is undone if 'version' is rolled back.
 *
 * Requires:
 * \li	'db' is a valid zone database.
 * \li	'version' is the active writer version of 'db'.
