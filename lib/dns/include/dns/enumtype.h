...
/*
 * DNS rdata type enumeration.
 *
 * Type codes are assigned by IANA:
 * https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml
 *
 * When adding a new type, add the enum value, the cast macro, and
 * create the corresponding type implementation in lib/dns/rdata/.
 */
