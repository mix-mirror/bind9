...
sign_a_node(dns_db_t *db, dns_zone_t *zone, dns_name_t *name,
	...
	bool seen_soa = false, seen_ns = false, seen_rr = false,
	     seen_nsec = false, seen_nsec3 = false, seen_ds = false,
	     seen_deleg ISC_ATTR_UNUSED = false;
...
zone_nsec3chain(dns_zone_t *zone) {
	...
	bool unsecure = false;
	bool seen_soa = false, seen_ns = false, seen_dname = false,
	     seen_ds = false, seen_deleg ISC_ATTR_UNUSED = false;
