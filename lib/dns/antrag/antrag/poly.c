...
void
print_poly(const poly *p) {
	int PRINT_SIZE = ANTRAG_D - 1;
	for (int i = 0; i < PRINT_SIZE; ++i)
		printf("%.1f, ", p->coeffs[i].v);
...
void
u16_poly_add(u16_poly *p1, const u16_poly *p2) {
	Zf(u16_poly_add)(p1->coeffs, p2->coeffs);
}
void
u16_poly_sub(u16_poly *p1, const u16_poly *p2) {
	Zf(u16_poly_sub)(p1->coeffs, p2->coeffs);
}
void
u16_poly_neg(u16_poly *p1, const u16_poly *p2) {
	Zf(u16_poly_neg)(p1->coeffs, p2->coeffs);
}
void
u16_poly_mul(u16_poly *p1, const u16_poly *p2_ntt) {
