...
static cfg_clausedef_t view_clauses[] = {
	...
	{ "grease-response-dns-flags", &cfg_type_boolean, 0 },
	{ "grease-response-edns-flags", &cfg_type_boolean, 0 },
	{ "grease-response-edns-option", &cfg_type_boolean, 0 },
	{ "grease-response-edns-version", &cfg_type_boolean, 0 },
