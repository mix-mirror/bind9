...
for subdomain in auto-nsec auto-nsec3 badds bogus \
  ...
  extended-ds-unknown-oid extrabadkey extradsoid extradsunknownoid \
  future keyless kskonly localkey lower managed-future multiple nsec3 \
  nsec3-unknown occluded optout optout-unknown revkey rsasha1 \
  rsasha1-1024 rsasha256 rsasha256oid rsasha512 rsasha512oid secure \
  secure.below-cname split-dnssec split-smart ttlpatch unknownoid \
  update-nsec3 upper; do
