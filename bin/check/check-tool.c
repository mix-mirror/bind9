...
dns_zoneopt_t zone_options = DNS_ZONEOPT_CHECKNS | DNS_ZONEOPT_FATALNS |
			     DNS_ZONEOPT_CHECKMX | DNS_ZONEOPT_CHECKDUPRR |
			     DNS_ZONEOPT_CHECKSPF | DNS_ZONEOPT_MANYERRORS |
