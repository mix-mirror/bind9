...
.. option:: +coflag, +co, +nocoflag, +noco
   ...
   existence Ok) EDNS bit in the query.  This tells servers that
   Compact Denial of Existence responses are ok when replying to
   queries.  The default is ``+nocoflag``.
