...
ISC_RUN_TEST_IMPL(deleg) {
	...
	wire_ok_t wire_ok[] = { /* too short */
				...
				WIRE_VALID(0x00, 0x00, 0x00, 0x02, 0x00,
					   0x20, 0x00, 0x20, 0x00, 0x00),
				/* mandatory=key32 key33 */
				WIRE_INVALID(0x00, 0x00, 0x00, 0x02, 0x00,
					     0x20, 0x00, 0x21, 0x00, 0x00),
				/* mandatory=key32 */
				WIRE_INVALID(0x00, 0x00, 0x00, 0x02, 0x00,
					     0x20),
				/*
				 ...
				 */
				WIRE_VALID(0x00, 0x00, 0x00, 0x06, 0x00,
					   0x0A, 0x00, 0x0B, 0x00, 0x0C,
					   0x00, 0x0A, 0x00, 0x01, 0x31,
					   0x00, 0x0B, 0x00, 0x01, 0x32,
					   0x00, 0x0C, 0x00, 0x01, 0x33),
				/*
				 * mandatory=key10,key11,key12
				 * key11=2 key12=3
				 */
				WIRE_INVALID(0x00, 0x00, 0x00, 0x06, 0x00,
					     0x0A, 0x00, 0x0B, 0x00, 0x0C,
					     0x00, 0x0B, 0x00, 0x01, 0x32,
					     0x00, 0x0C, 0x00, 0x01, 0x33),
				/*
